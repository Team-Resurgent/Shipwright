...
/*
   ...
   Hand-written for the RXDK / Xbox (picolibc + zig/clang, 32-bit x86) build of
   libzip 1.11.4. Normally generated by CMake from zipconf.h.in.
 */
...
/* Static-only build (no DLL export/import decoration). */
#define ZIP_STATIC
